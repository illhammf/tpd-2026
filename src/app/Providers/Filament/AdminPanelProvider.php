...
class AdminPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->brandLogo(asset('storage/' . (\App\Models\PengaturanWebsite::first()?->logo ?? '')))
            ->favicon(asset('storage/' . (\App\Models\PengaturanWebsite::first()?->favicon ?? '')))
            ->spa()
            ->login()
            ->passwordReset()
            ...
            ->navigationGroups([
                ...
                NavigationGroup::make()
                    ->label('Interaksi Pengguna')
                    ->collapsed(false),

                NavigationGroup::make()
                    ->label('Aturan Booking')
                    ->collapsed(false),
                ...
                NavigationGroup::make()
                    ...
                    ->collapsed(true), # untuk tanda bahwa ini adalah menu khusus admin, bisa disembunyikan untuk role lain
            ])
            ->userMenuItems([
